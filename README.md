...
La implementación de un programa de mantenimiento preventivo basado en el análisis de datos históricos reducirá el tiempo de inactividad de las máquinas en un 15% y disminuirá los defectos de producción en un 10% durante el primer semestre de aplicación."
Variable independiente: Frecuencia de mantenimiento preventivo.
Variable dependiente: Tasa de defectos y horas de inactividad
